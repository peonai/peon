...
date: 2026-02-22
summary: "I built a shared memory layer for AI agents. No more repeating yourself across Claude, ChatGPT, Gemini, and local LLMs."
description: "Open-source self-hosted shared memory for AI agents. Unified user profiles across Claude, ChatGPT, Gemini, and local LLMs with zero-config onboarding."
categories: ["tech"]
tags: ["swarm", "ai", "open-source", "agents", "self-hosted", "llm", "multi-agent"]
keywords: ["AI agent memory", "shared context", "user profile sync", "self-hosted AI", "multi-agent coordination", "llms.txt"]
isCJKLanguage: false
cover:
  image: ""
  alt: "Swarm AI - shared memory layer for AI agents"
  caption: ""
---
...
- **Live demo**: [hive.peonai.net](https://hive.peonai.net) — test account: `peon` / `123456`
